...
int main()
{
	...
	while (true) {
		...
		if (runningCase == 41) {
			...
			if (runLenth > 100)TargetSpeed = 20;
			if (runLenth > 130)TargetSpeed = 45;
			if (runLenth > 160)TargetSpeed = 45;
			if (runLenth > 210)TargetSpeed = 60;
			if (runLenth > 260)TargetSpeed = 45;
			if (runLenth > 400)TargetSpeed = 50;
			if (runLenth > 450)TargetSpeed = 70;
			if (runLenth > 570)TargetSpeed = 45;
			//if (runLenth > 660)TargetSpeed = 20;
			if (runLenth > 690)TargetSpeed = 40;
			if (runLenth > 840)TargetSpeed = 100;
			if (runLenth > 1060)TargetSpeed = 82;
			if (runLenth > 1340)TargetSpeed = 100;
			if (runLenth > 1520)TargetSpeed = 50;
			if (runLenth > 1570)TargetSpeed = 60;
			if (runLenth > 1640)TargetSpeed = 50;
			if (runLenth > 1690)TargetSpeed = 90;
			if (runLenth > 1880)TargetSpeed = 80;
			if (runLenth > 2160)TargetSpeed = 50;
			if (runLenth > 2220)TargetSpeed = 100;
			if (runLenth > 2410)TargetSpeed = 70;
			if (runLenth > 2540)TargetSpeed = 45;
			if (runLenth > 2600)TargetSpeed = 80;
			if (runLenth > 2710)TargetSpeed = 75;
			if (runLenth > 3030)TargetSpeed = 60;
			if (runLenth > 3080)TargetSpeed = 50;
		}
